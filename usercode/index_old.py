...
from mypackage.helper import line_count, file_batch, batched
...
if __name__ == "__main__":
    ...
    parser.add_argument("-name", action="store", type=str, help="Index name", default="pubmed-index")
    ...
    if args.empty:
        ...
        if not args.no_index:
            create_index(client, index_name, "../mapping.json")
            indexing()
