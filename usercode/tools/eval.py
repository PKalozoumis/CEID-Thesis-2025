...
def compare_docs(args: argparse.Namespace, sess: Session, db: DatabaseSession, docs: list[ElasticDocument]):
...
def compare_experiments(args: argparse.Namespace, sess: Session, db: DatabaseSession, docs: list[ElasticDocument]):
