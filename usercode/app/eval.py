...
from mypackage.helper.retrieval_metrics import precision, recall, fscore, mean_average_precision, mean_reciprocal_rank, average_precision, micro_avg_precision, micro_avg_recall, micro_avg_fscore
...
def retrieval_evaluation(multiple_exp_results: list[list[RealTimeResults]], eval_relevance_threshold: float = 5.3):
    ...
    for results in multiple_exp_results[0]:
        ...
        single_query_results = [doc.id for doc in results.returned_docs]
